    ...
    return (host) => {
        return schematics_1.chain([
            ...
            workspace_1.updateJsonInTree(`${options.appProjectRoot}/tsconfig.app.json`, json => {
                return Object.assign({}, json, { extends: `./tsconfig.json`, compilerOptions: Object.assign({}, json.compilerOptions, { outDir: `${workspace_1.offsetFromRoot(options.appProjectRoot)}dist/out-tsc` }), exclude: options.unitTestRunner === 'jest'
