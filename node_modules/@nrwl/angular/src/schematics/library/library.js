      ...
      it('should create', () => {
        ...
        return schematics_1.chain([
            ...
            workspace_1.updateJsonInTree(`${options.projectRoot}/tsconfig.lib.json`, json => {
                ...
                return Object.assign({}, json, { extends: `./tsconfig.json`, compilerOptions: Object.assign({}, json.compilerOptions, { outDir: `${workspace_1.offsetFromRoot(options.projectRoot)}dist/out-tsc` }), exclude: options.unitTestRunner === 'jest'
