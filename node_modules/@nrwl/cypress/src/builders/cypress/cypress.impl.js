...
function run(options, context) {
    ...
    return (!legacy
        ? options.devServerTarget
            ? startDevServer(options.devServerTarget, options.watch, context).pipe(operators_1.map(output => output.baseUrl))
...
function startDevServer(devServerTarget, isWatching, context) {
    ...
    return architect_1.scheduleTargetAndForget(context, architect_1.targetFromTargetString(devServerTarget), overrides);
}
